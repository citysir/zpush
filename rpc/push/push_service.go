...
//  - FunCode
//  - ParamMap
func (p *PushServiceClient) FunCall(callTime int64, funCode string, paramMap map[string]string) (r []string, err error) {
...
func (p *PushServiceClient) sendFunCall(callTime int64, funCode string, paramMap map[string]string) (err error) {
...
func NewPushServiceProcessor(handler PushService) *PushServiceProcessor {
	...
	self4 := &PushServiceProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self4.processorMap["funCall"] = &pushServiceProcessorFunCall{handler: handler}
	return self4
}
...
type pushServiceProcessorFunCall struct {
	handler PushService
}

func (p *pushServiceProcessorFunCall) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := NewFunCallArgs()
